...
public class TextCorpusMorphologyTest extends AbstractTextCorpusTest {
    ...
    private static final String INPUT_FILE_WITH_LAYER = "/data_v5/tc-morph/tcf-after.xml";
    private static final String EXPECTED_OUTPUT_FILE = "/data_v5/tc-morph/output-expected.xml";
    private static final String OUTPUT_FILE = "output.xml";

    private static final String INPUT_FILE_WITH_LAYER_TAGSET = "/data_v5/tc-morph/tcf-afterTagSet.xml";
    private static final String EXPECTED_OUTPUT_FILE_TAGSET = "/data_v5/tc-morph/output-expectedTagSet.xml";
