 ...
 *
 */
@XmlRootElement(name = HyperonymyLayerStored.XML_NAME)
@XmlAccessorType(XmlAccessType.NONE)
public class HyperonymyLayerStored extends LexicalSemanticsLayerStored {

    public static final String XML_NAME = "hyperonymy";
    ...
    protected void setLayersConnector(TextCorpusLayersConnector connector) {
        ...
        for (OrthformStored orthform : super.orthforms) {
            for (String lemRef : orthform.lemmaRefs) {
                connector.lemma2ItsHyperonyms.put(connector.lemmaId2ItsLemma.get(lemRef), orthform);
            }
        }
    }
    ...
    public Orthform getOrthform(Lemma lemma) {
        return super.connector.lemma2ItsHyperonyms.get(lemma);
    }
