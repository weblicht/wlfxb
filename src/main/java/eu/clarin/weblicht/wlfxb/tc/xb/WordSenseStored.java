...
public class WordSenseStored implements WordSense {

    public static final String XML_NAME = "ws";

    @XmlAttribute(name = "lexunits", required = true)
    ...
    public String toString() {
        ...
        sb.append(Arrays.toString(lexunits)).append(" ").append(Arrays.toString(tokRefs));
        if (comment != null) {
            sb.append(comment);
        }
        return sb.toString();
