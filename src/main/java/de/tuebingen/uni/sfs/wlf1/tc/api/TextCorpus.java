...
public interface TextCorpus {
	...
	/**
	 * Creates empty references layers, ready to be filled in with the references data
	 ...
	 * @param externalReferencesSource name of external source 
	 * (should be null if entities from the external source are not referenced)
