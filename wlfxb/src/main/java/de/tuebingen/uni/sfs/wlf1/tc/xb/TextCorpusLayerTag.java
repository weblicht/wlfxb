...
public enum TextCorpusLayerTag {
    ...
    COREFERENCES(CoreferencesLayerStored.XML_NAME, CoreferencesLayerStored.class),
    ...
    private static Map<String, TextCorpusLayerTag> xmlNameToLayerTagMap =
    ...
    private static Map<Class<? extends TextCorpusLayer>, TextCorpusLayerTag> classToLayerTagMap =
